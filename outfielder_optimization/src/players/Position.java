...
public class Position {
    ...
    public Position(Double lfx, Double lfy, Double cfx, Double cfy, Double rfx, Double rfy, Batter B, Fielder LF, Fielder CF, Fielder RF, Pitcher P) throws IOException {
        batter = B;
        leftFielder = LF;
        centerFielder = CF;
        rightFielder = RF;
